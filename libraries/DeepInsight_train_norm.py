...
from libraries.Cart2Pixel import Cart2Pixel
...
def train_norm(param, dataset, norm, filename = ""):
    ...
    if not param["LoadFromJson"]:
        ...
        XGlobal, image_model, toDelete = Cart2Pixel(q, q["max_A_size"], q["max_B_size"], param["Dynamic_Size"],
                                                    mutual_info=param["mutual_info"], params=param, only_model=False, filename= filename)
        ...
        filename = param["dir"] + filename + "_test" + name + ".pickle"
