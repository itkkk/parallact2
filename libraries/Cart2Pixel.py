...
from libraries.MinRect import minimum_bounding_rectangle
from libraries.ConvPixel import ConvPixel
import numpy as np
...
def Cart2Pixel(Q=None, A=None, B=None, dynamic_size=False, mutual_info=False, only_model=False, params=None, filename = ""):
    ...
    if Q["method"] == 'pca':
        ...
        tsne = TSNE(n_components=2, method="exact", random_state=180, perplexity=30)
    ...
    if only_model:
        ...
        plt.show()
        filename = params["dir"] + filename + "_train" + name + ".pickle"
